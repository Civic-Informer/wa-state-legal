---
name: rcw-title-48
description: Use when the user asks about, cites, quotes, or compares Title 48 RCW — insurance — insurer licensing, market conduct, rate filings, health insurance, the Insurance Commissioner, surplus lines, captives. Triggers on citations like `RCW 48.`, chapter cites within Title 48, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 48 (101 chapters, 4,051,090 bytes)
```
...
grep -n -E '^## RCW 48\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+48\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
