---
name: rcw-title-50
description: Use when the user asks about, cites, quotes, or compares Title 50 RCW — unemployment compensation — benefits, employer tax, eligibility, appeals. Triggers on citations like `RCW 50.`, chapter cites within Title 50, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 50 (25 chapters, 883,869 bytes)
```
...
grep -n -E '^## RCW 50\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+50\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
