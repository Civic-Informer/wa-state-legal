---
name: rcw-title-32
description: Use when the user asks about, cites, quotes, or compares Title 32 RCW — the Washington Savings Bank Act — mutual and stock savings banks. Triggers on citations like `RCW 32.`, chapter cites within Title 32, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 32 (14 chapters, 371,698 bytes)
```
...
grep -n -E '^## RCW 32\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+32\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
