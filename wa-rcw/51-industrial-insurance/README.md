---
name: rcw-title-51
description: Use when the user asks about, cites, quotes, or compares Title 51 RCW — industrial insurance (workers' compensation) — coverage, benefits, employer accounts, third-party recovery. Triggers on citations like `RCW 51.`, chapter cites within Title 51, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 51 (14 chapters, 816,444 bytes)
```
...
grep -n -E '^## RCW 51\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+51\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
