---
name: rcw-title-53
description: Use when the user asks about, cites, quotes, or compares Title 53 RCW — port districts. Triggers on citations like `RCW 53.`, chapter cites within Title 53, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 53 (24 chapters, 418,026 bytes)
```
...
grep -n -E '^## RCW 53\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+53\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
