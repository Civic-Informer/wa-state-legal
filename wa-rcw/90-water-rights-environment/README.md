---
name: rcw-title-90
description: Use when the user asks about, cites, quotes, or compares Title 90 RCW — water rights and water resources, state environmental policy, shorelines management. Triggers on citations like `RCW 90.`, chapter cites within Title 90, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 90 (31 chapters, 1,356,997 bytes)
```
...
grep -n -E '^## RCW 90\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+90\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
