---
name: rcw-title-89
description: Use when the user asks about, cites, quotes, or compares Title 89 RCW — reclamation, soil conservation, and land settlement — conservation districts. Triggers on citations like `RCW 89.`, chapter cites within Title 89, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 89 (6 chapters, 361,725 bytes)
```
...
grep -n -E '^## RCW 89\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+89\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
