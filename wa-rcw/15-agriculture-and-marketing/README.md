---
name: rcw-title-15
description: Use when the user asks about, cites, quotes, or compares Title 15 RCW — agriculture and marketing, commodity commissions, plant and seed regulation. Triggers on citations like `RCW 15.`, chapter cites within Title 15, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 15 (49 chapters, 1,392,347 bytes)
```
...
grep -n -E '^## RCW 15\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+15\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
