---
name: rcw-title-47
description: Use when the user asks about, cites, quotes, or compares Title 47 RCW — public highways and transportation — Washington State Department of Transportation, highways, ferries, tolling. Triggers on citations like `RCW 47.`, chapter cites within Title 47, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 47 (45 chapters, 1,942,449 bytes)
```
...
grep -n -E '^## RCW 47\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+47\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
