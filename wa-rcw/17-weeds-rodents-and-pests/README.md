---
name: rcw-title-17
description: Use when the user asks about, cites, quotes, or compares Title 17 RCW — weed control districts, pest control, pesticides, noxious weeds. Triggers on citations like `RCW 17.`, chapter cites within Title 17, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 17 (10 chapters, 347,813 bytes)
```
...
grep -n -E '^## RCW 17\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+17\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
