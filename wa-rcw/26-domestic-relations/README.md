---
name: rcw-title-26
description: Use when the user asks about, cites, quotes, or compares Title 26 RCW — domestic relations — marriage, dissolution, parenting plans, child support, domestic partnerships, parentage. Triggers on citations like `RCW 26.`, chapter cites within Title 26, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 26 (26 chapters, 1,350,790 bytes)
```
...
grep -n -E '^## RCW 26\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+26\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
