---
name: rcw-title-54
description: Use when the user asks about, cites, quotes, or compares Title 54 RCW — public utility districts. Triggers on citations like `RCW 54.`, chapter cites within Title 54, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 54 (13 chapters, 310,309 bytes)
```
...
grep -n -E '^## RCW 54\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+54\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
