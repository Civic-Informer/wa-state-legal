---
name: rcw-title-61
description: Use when the user asks about, cites, quotes, or compares Title 61 RCW — mortgages, deeds of trust, real estate contracts — judicial and nonjudicial foreclosure, mortgage assistance. Triggers on citations like `RCW 61.`, chapter cites within Title 61, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 61 (8 chapters, 406,802 bytes)
```
...
grep -n -E '^## RCW 61\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+61\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
