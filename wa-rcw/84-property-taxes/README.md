---
name: rcw-title-84
description: Use when the user asks about, cites, quotes, or compares Title 84 RCW — property taxes — assessment, levy, property tax exemptions, senior citizen / disabled exemptions, current use valuation. Triggers on citations like `RCW 84.`, chapter cites within Title 84, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 84 (29 chapters, 1,270,435 bytes)
```
...
grep -n -E '^## RCW 84\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+84\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
