---
name: rcw-title-37
description: Use when the user asks about, cites, quotes, or compares Title 37 RCW — federal lands and Indian relations — jurisdiction over federal areas, state-tribal compacts. Triggers on citations like `RCW 37.`, chapter cites within Title 37, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 37 (4 chapters, 45,115 bytes)
```
...
grep -n -E '^## RCW 37\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+37\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
