---
name: rcw-title-23
description: Use when the user asks about, cites, quotes, or compares Title 23 RCW — profit corporations (legacy provisions; see Title 23B for the active Washington Business Corporation Act). Triggers on citations like `RCW 23.`, chapter cites within Title 23, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 23 (5 chapters, 315,443 bytes)
```
...
grep -n -E '^## RCW 23\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+23\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
