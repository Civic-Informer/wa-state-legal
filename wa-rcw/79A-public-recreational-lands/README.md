---
name: rcw-title-79a
description: Use when the user asks about, cites, quotes, or compares Title 79A RCW — public recreational lands — state parks, recreation and conservation, scenic rivers. Triggers on citations like `RCW 79A.`, chapter cites within Title 79A, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 79A (13 chapters, 555,737 bytes)
```
...
grep -n -E '^## RCW 79A\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+79A\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
