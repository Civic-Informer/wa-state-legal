---
name: rcw-title-64
description: Use when the user asks about, cites, quotes, or compares Title 64 RCW — real property and conveyances — deeds, covenants, easements, condominiums, common-interest communities, real-estate brokerage. Triggers on citations like `RCW 64.`, chapter cites within Title 64, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 64 (22 chapters, 1,388,995 bytes)
```
...
grep -n -E '^## RCW 64\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+64\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
