---
name: rcw-title-83
description: Use when the user asks about, cites, quotes, or compares Title 83 RCW — estate taxation — Washington estate tax. Triggers on citations like `RCW 83.`, chapter cites within Title 83, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 83 (2 chapters, 102,068 bytes)
```
...
grep -n -E '^## RCW 83\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+83\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
