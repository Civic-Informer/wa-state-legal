---
name: rcw-title-09
description: Use when the user asks about, cites, quotes, or compares Title 09 RCW — general crimes and punishments (assault, theft, drugs, weapons, gambling, public order offenses) — see Title 9A for the codified Washington Criminal Code. Triggers on citations like `RCW 09.`, chapter cites within Title 09, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 09 RCW — CRIMES AND PUNISHMENTS
...
```
09-crimes-and-punishments/
├── README.md   ← you are here
└── rules.md    ← consolidated text of every chapter in Title 09 (48 chapters, 2,110,097 bytes)
```
...
grep -n -E '^## RCW 09\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+09\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
