---
name: rcw-title-08
description: Use when the user asks about, cites, quotes, or compares Title 08 RCW — eminent domain, condemnation procedure, public-use takings, compensation for property taken by state and local entities. Triggers on citations like `RCW 08.`, chapter cites within Title 08, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 08 (9 chapters, 222,284 bytes)
```
...
grep -n -E '^## RCW 08\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+08\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
