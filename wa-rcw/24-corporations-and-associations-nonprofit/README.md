---
name: rcw-title-24
description: Use when the user asks about, cites, quotes, or compares Title 24 RCW — nonprofit corporations and unincorporated associations (charitable, religious, cooperative). Triggers on citations like `RCW 24.`, chapter cites within Title 24, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 24 (13 chapters, 588,890 bytes)
```
...
grep -n -E '^## RCW 24\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+24\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
