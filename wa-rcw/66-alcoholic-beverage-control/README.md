---
name: rcw-title-66
description: Use when the user asks about, cites, quotes, or compares Title 66 RCW — alcoholic beverage control — liquor licensing, sales, taxation, Liquor and Cannabis Board. Triggers on citations like `RCW 66.`, chapter cites within Title 66, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 66 (11 chapters, 668,651 bytes)
```
...
grep -n -E '^## RCW 66\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+66\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
