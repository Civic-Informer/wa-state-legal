---
name: rcw-title-68
description: Use when the user asks about, cites, quotes, or compares Title 68 RCW — cemeteries, morgues, disposition of human remains, anatomical gifts. Triggers on citations like `RCW 68.`, chapter cites within Title 68, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 68 (17 chapters, 324,246 bytes)
```
...
grep -n -E '^## RCW 68\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+68\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
