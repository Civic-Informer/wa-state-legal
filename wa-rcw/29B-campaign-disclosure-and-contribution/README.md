---
name: rcw-title-29b
description: Use when the user asks about, cites, quotes, or compares Title 29B RCW — campaign finance disclosure, contribution limits, the Public Disclosure Commission. Triggers on citations like `RCW 29B.`, chapter cites within Title 29B, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
```
29B-campaign-disclosure-and-contribution/
├── README.md   ← you are here
└── rules.md    ← consolidated text of every chapter in Title 29B (12 chapters, 351,548 bytes)
```
...
grep -n -E '^## RCW 29B\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+29B\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
