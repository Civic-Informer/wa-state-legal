---
name: rcw-title-28b
description: Use when the user asks about, cites, quotes, or compares Title 28B RCW — higher education — universities, community/technical colleges, financial aid, governance. Triggers on citations like `RCW 28B.`, chapter cites within Title 28B, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 28B (54 chapters, 2,121,902 bytes)
```
...
grep -n -E '^## RCW 28B\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+28B\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
