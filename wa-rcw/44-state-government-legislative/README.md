---
name: rcw-title-44
description: Use when the user asks about, cites, quotes, or compares Title 44 RCW — state government legislative branch — Legislature, legislative committees, redistricting, codes reviser, legislative ethics. Triggers on citations like `RCW 44.`, chapter cites within Title 44, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 44 (14 chapters, 544,393 bytes)
```
...
grep -n -E '^## RCW 44\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+44\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
