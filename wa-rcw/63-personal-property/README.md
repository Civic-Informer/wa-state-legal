---
name: rcw-title-63
description: Use when the user asks about, cites, quotes, or compares Title 63 RCW — personal property — sales, replevin, unclaimed property, gift cards. Triggers on citations like `RCW 63.`, chapter cites within Title 63, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 63 (15 chapters, 326,681 bytes)
```
...
grep -n -E '^## RCW 63\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+63\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
