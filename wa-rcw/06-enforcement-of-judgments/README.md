---
name: rcw-title-06
description: Use when the user asks about, cites, quotes, or compares Title 06 RCW — judgment liens, executions, garnishment, attachments, supplemental proceedings, exemptions from execution. Triggers on citations like `RCW 06.`, chapter cites within Title 06, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 06 RCW — ENFORCEMENT OF JUDGMENTS
...
```
06-enforcement-of-judgments/
├── README.md   ← you are here
└── rules.md    ← consolidated text of every chapter in Title 06 (15 chapters, 380,470 bytes)
```
...
grep -n -E '^## RCW 06\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+06\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
