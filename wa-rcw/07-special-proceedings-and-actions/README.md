---
name: rcw-title-07
description: Use when the user asks about, cites, quotes, or compares Title 07 RCW — special proceedings (mandamus, prohibition, quo warranto, injunctions), small claims, arbitration, partition, protection orders. Triggers on citations like `RCW 07.`, chapter cites within Title 07, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 07 RCW — SPECIAL PROCEEDINGS AND ACTIONS
...
```
07-special-proceedings-and-actions/
├── README.md   ← you are here
└── rules.md    ← consolidated text of every chapter in Title 07 (43 chapters, 1,248,813 bytes)
```
...
grep -n -E '^## RCW 07\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+07\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
