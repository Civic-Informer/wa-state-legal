---
name: rcw-title-04
description: Use when the user asks about, cites, quotes, or compares Title 04 RCW — civil procedure, statute of limitations, wrongful death actions, joinder of parties, costs, attorneys' fees, public expression protection (anti-SLAPP). Triggers on citations like `RCW 04.`, chapter cites within Title 04, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 04 RCW — CIVIL PROCEDURE
...
└── rules.md    ← consolidated text of every chapter in Title 04 (29 chapters, 579,017 bytes)
```
...
grep -n -E '^## RCW 04\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+04\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
