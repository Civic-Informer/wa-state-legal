---
name: rcw-title-41
description: Use when the user asks about, cites, quotes, or compares Title 41 RCW — public employment — civil service, public retirement systems (PERS, TRS, LEOFF, PSERS), collective bargaining, family medical leave. Triggers on citations like `RCW 41.`, chapter cites within Title 41, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 41 (37 chapters, 3,026,810 bytes)
```
...
grep -n -E '^## RCW 41\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+41\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
