---
name: rcw-title-13
description: Use when the user asks about, cites, quotes, or compares Title 13 RCW — juvenile court — dependencies, terminations, offenses, sentencing, family reconciliation. Triggers on citations like `RCW 13.`, chapter cites within Title 13, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 13 (16 chapters, 1,029,062 bytes)
```
...
grep -n -E '^## RCW 13\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+13\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
