---
name: rcw-title-73
description: Use when the user asks about, cites, quotes, or compares Title 73 RCW — veterans' affairs — state veterans homes, veterans' benefits, military service protections. Triggers on citations like `RCW 73.`, chapter cites within Title 73, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 73 (7 chapters, 113,734 bytes)
```
...
grep -n -E '^## RCW 73\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+73\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
