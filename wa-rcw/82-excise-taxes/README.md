---
name: rcw-title-82
description: Use when the user asks about, cites, quotes, or compares Title 82 RCW — excise taxes — Business and Occupation tax (B&O), retail sales/use tax, public utility tax, tax preferences and credits. Triggers on citations like `RCW 82.`, chapter cites within Title 82, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 82 (63 chapters, 8,190,206 bytes)
```
...
grep -n -E '^## RCW 82\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+82\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
