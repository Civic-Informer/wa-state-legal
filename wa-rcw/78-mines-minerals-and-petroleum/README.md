---
name: rcw-title-78
description: Use when the user asks about, cites, quotes, or compares Title 78 RCW — mines, minerals, and petroleum — mine safety, surface mining reclamation, oil and gas. Triggers on citations like `RCW 78.`, chapter cites within Title 78, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 78 (10 chapters, 290,647 bytes)
```
...
grep -n -E '^## RCW 78\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+78\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
