---
name: rcw-title-52
description: Use when the user asks about, cites, quotes, or compares Title 52 RCW — fire protection districts. Triggers on citations like `RCW 52.`, chapter cites within Title 52, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 52 (14 chapters, 286,431 bytes)
```
...
grep -n -E '^## RCW 52\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+52\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
