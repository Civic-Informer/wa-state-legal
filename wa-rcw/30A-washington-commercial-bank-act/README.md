---
name: rcw-title-30a
description: Use when the user asks about, cites, quotes, or compares Title 30A RCW — the Washington Commercial Bank Act — state-chartered banks, branches, mergers, examination. Triggers on citations like `RCW 30A.`, chapter cites within Title 30A, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 30A RCW — WASHINGTON COMMERCIAL BANK ACT
...
└── rules.md    ← consolidated text of every chapter in Title 30A (18 chapters, 439,713 bytes)
```
...
grep -n -E '^## RCW 30A\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+30A\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
