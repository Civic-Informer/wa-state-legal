---
name: rcw-title-49
description: Use when the user asks about, cites, quotes, or compares Title 49 RCW — labor regulations — wages and hours, minimum wage, paid sick leave, occupational safety, anti-discrimination, family leave. Triggers on citations like `RCW 49.`, chapter cites within Title 49, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 49 (40 chapters, 1,275,147 bytes)
```
...
grep -n -E '^## RCW 49\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+49\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
