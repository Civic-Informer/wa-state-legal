---
name: rcw-title-20
description: Use when the user asks about, cites, quotes, or compares Title 20 RCW — commission merchants and agricultural products marketing. Triggers on citations like `RCW 20.`, chapter cites within Title 20, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 20 (1 chapters, 92,467 bytes)
```
...
grep -n -E '^## RCW 20\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+20\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
