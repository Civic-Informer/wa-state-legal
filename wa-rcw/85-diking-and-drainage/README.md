---
name: rcw-title-85
description: Use when the user asks about, cites, quotes, or compares Title 85 RCW — diking and drainage districts. Triggers on citations like `RCW 85.`, chapter cites within Title 85, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 85 (15 chapters, 524,476 bytes)
```
...
grep -n -E '^## RCW 85\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+85\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
