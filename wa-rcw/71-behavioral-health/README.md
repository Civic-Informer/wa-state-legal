---
name: rcw-title-71
description: Use when the user asks about, cites, quotes, or compares Title 71 RCW — behavioral health — Involuntary Treatment Act, civil commitment, behavioral health services. Triggers on citations like `RCW 71.`, chapter cites within Title 71, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 71 (13 chapters, 1,563,094 bytes)
```
...
grep -n -E '^## RCW 71\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+71\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
