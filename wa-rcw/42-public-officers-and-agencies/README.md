---
name: rcw-title-42
description: Use when the user asks about, cites, quotes, or compares Title 42 RCW — public officers and agencies — Open Public Meetings Act, Public Records Act, ethics in public service, oaths, code of ethics. Triggers on citations like `RCW 42.`, chapter cites within Title 42, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 42 (20 chapters, 966,890 bytes)
```
...
grep -n -E '^## RCW 42\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+42\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
