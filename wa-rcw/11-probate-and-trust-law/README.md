---
name: rcw-title-11
description: Use when the user asks about, cites, quotes, or compares Title 11 RCW — probate, wills, intestate succession, trusts, guardianship, estate administration, TEDRA. Triggers on citations like `RCW 11.`, chapter cites within Title 11, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 11 (52 chapters, 1,638,126 bytes)
```
...
grep -n -E '^## RCW 11\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+11\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
