---
name: rcw-title-01
description: Use when the user asks about, cites, quotes, or compares Title 01 RCW — general definitions (RCW 1.16), rules of construction (RCW 1.12), and basic legal terminology used throughout the RCW. Triggers on citations like `RCW 01.`, chapter cites within Title 01, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 01 RCW — GENERAL PROVISIONS
...
└── rules.md    ← consolidated text of every chapter in Title 01 (11 chapters, 159,630 bytes)
```
...
grep -n -E '^## RCW 01\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+01\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
