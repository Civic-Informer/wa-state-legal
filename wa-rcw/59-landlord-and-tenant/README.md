---
name: rcw-title-59
description: Use when the user asks about, cites, quotes, or compares Title 59 RCW — landlord-tenant — Residential Landlord-Tenant Act, mobile home park tenancies, manufactured/mobile home tenancies, unlawful detainer. Triggers on citations like `RCW 59.`, chapter cites within Title 59, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 59 (11 chapters, 632,850 bytes)
```
...
grep -n -E '^## RCW 59\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+59\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
