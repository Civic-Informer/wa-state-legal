---
name: rcw-title-05
description: Use when the user asks about, cites, quotes, or compares Title 05 RCW — rules of evidence, privileges, witness competency, hearsay exceptions in civil and criminal proceedings. Triggers on citations like `RCW 05.`, chapter cites within Title 05, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 05 RCW — EVIDENCE
...
└── rules.md    ← consolidated text of every chapter in Title 05 (17 chapters, 121,709 bytes)
```
...
grep -n -E '^## RCW 05\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+05\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
