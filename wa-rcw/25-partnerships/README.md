---
name: rcw-title-25
description: Use when the user asks about, cites, quotes, or compares Title 25 RCW — partnerships — general partnerships, limited partnerships, LLPs, RUPA. Triggers on citations like `RCW 25.`, chapter cites within Title 25, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 25 (4 chapters, 398,886 bytes)
```
...
grep -n -E '^## RCW 25\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+25\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
