---
name: rcw-title-58
description: Use when the user asks about, cites, quotes, or compares Title 58 RCW — boundaries and plats — county boundaries, surveys, platting, condominiums, short subdivisions, real-estate subdivision regulation. Triggers on citations like `RCW 58.`, chapter cites within Title 58, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 58 (11 chapters, 252,139 bytes)
```
...
grep -n -E '^## RCW 58\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+58\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
