---
name: rcw-title-35
description: Use when the user asks about, cites, quotes, or compares Title 35 RCW — cities and towns — municipal incorporation, governance, powers, code/charter cities. Triggers on citations like `RCW 35.`, chapter cites within Title 35, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 35 (91 chapters, 2,532,501 bytes)
```
...
grep -n -E '^## RCW 35\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+35\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
