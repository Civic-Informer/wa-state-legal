---
name: rcw-title-88
description: Use when the user asks about, cites, quotes, or compares Title 88 RCW — navigation and harbor improvements — pilotage, harbor lines, marinas. Triggers on citations like `RCW 88.`, chapter cites within Title 88, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 88 (11 chapters, 401,374 bytes)
```
...
grep -n -E '^## RCW 88\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+88\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
