---
name: rcw-title-69
description: Use when the user asks about, cites, quotes, or compares Title 69 RCW — food, drugs, cosmetics, poisons — Uniform Controlled Substances Act, drug paraphernalia, food safety, cannabis. Triggers on citations like `RCW 69.`, chapter cites within Title 69, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 69 (31 chapters, 1,146,664 bytes)
```
...
grep -n -E '^## RCW 69\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+69\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
