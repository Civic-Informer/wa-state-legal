...
> **Shared rules document.** Mount Vernon Municipal Court operates under the Skagit County District Court rules. The text below is that shared document; the municipal court applies these rules within its jurisdiction. Other municipal courts in Skagit County that share this document: Anacortes, Burlington.
