---
name: rcw-title-57
description: Use when the user asks about, cites, quotes, or compares Title 57 RCW — water-sewer districts. Triggers on citations like `RCW 57.`, chapter cites within Title 57, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 57 (15 chapters, 314,320 bytes)
```
...
grep -n -E '^## RCW 57\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+57\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
