---
name: rcw-title-86
description: Use when the user asks about, cites, quotes, or compares Title 86 RCW — flood control districts. Triggers on citations like `RCW 86.`, chapter cites within Title 86, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 86 (9 chapters, 244,588 bytes)
```
...
grep -n -E '^## RCW 86\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+86\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
