---
name: rcw-title-91
description: Use when the user asks about, cites, quotes, or compares Title 91 RCW — waterways and dredging. Triggers on citations like `RCW 91.`, chapter cites within Title 91, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 91 (1 chapters, 70,529 bytes)
```
...
grep -n -E '^## RCW 91\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+91\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
