---
name: rcw-title-55
description: Use when the user asks about, cites, quotes, or compares Title 55 RCW — sanitary districts. Triggers on citations like `RCW 55.`, chapter cites within Title 55, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 55 RCW — SANITARY DISTRICTS
...
└── rules.md    ← consolidated text of every chapter in Title 55 (1 chapters, 1,820 bytes)
```
...
grep -n -E '^## RCW 55\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+55\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
