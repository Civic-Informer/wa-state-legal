---
name: rcw-title-70a
description: Use when the user asks about, cites, quotes, or compares Title 70A RCW — environmental health and safety — water quality, air quality, solid waste, hazardous waste, climate commitment, cleanup. Triggers on citations like `RCW 70A.`, chapter cites within Title 70A, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 70A (87 chapters, 2,787,102 bytes)
```
...
grep -n -E '^## RCW 70A\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+70A\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
