---
name: rcw-title-81
description: Use when the user asks about, cites, quotes, or compares Title 81 RCW — transportation — common carriers, motor carriers, railroads, vessel pilotage, regulated transportation. Triggers on citations like `RCW 81.`, chapter cites within Title 81, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 81 (35 chapters, 690,073 bytes)
```
...
grep -n -E '^## RCW 81\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+81\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
