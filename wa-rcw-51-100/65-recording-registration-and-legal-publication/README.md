---
name: rcw-title-65
description: Use when the user asks about, cites, quotes, or compares Title 65 RCW — recording, registration, and legal publication — auditor recording, real-estate excise tax disclosure, marketable title. Triggers on citations like `RCW 65.`, chapter cites within Title 65, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 65 (5 chapters, 95,626 bytes)
```
...
grep -n -E '^## RCW 65\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+65\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
