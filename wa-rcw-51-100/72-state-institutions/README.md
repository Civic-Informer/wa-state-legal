---
name: rcw-title-72
description: Use when the user asks about, cites, quotes, or compares Title 72 RCW — state institutions — Department of Corrections facilities, juvenile rehabilitation, state hospitals. Triggers on citations like `RCW 72.`, chapter cites within Title 72, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 72 (33 chapters, 799,394 bytes)
```
...
grep -n -E '^## RCW 72\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+72\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
