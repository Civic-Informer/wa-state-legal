---
name: rcw-title-70
description: Use when the user asks about, cites, quotes, or compares Title 70 RCW — public health and safety (legacy chapters; many provisions migrated to Title 70A). Triggers on citations like `RCW 70.`, chapter cites within Title 70, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 70 (98 chapters, 2,776,996 bytes)
```
...
grep -n -E '^## RCW 70\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+70\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
