---
name: rcw-title-74
description: Use when the user asks about, cites, quotes, or compares Title 74 RCW — public assistance — TANF, food stamps, medical assistance, child welfare, adult protective services. Triggers on citations like `RCW 74.`, chapter cites within Title 74, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 74 (41 chapters, 2,133,164 bytes)
```
...
grep -n -E '^## RCW 74\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+74\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
