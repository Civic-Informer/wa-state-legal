---
name: rcw-title-80
description: Use when the user asks about, cites, quotes, or compares Title 80 RCW — public utilities — Utilities and Transportation Commission, electric/gas/telecom utility regulation. Triggers on citations like `RCW 80.`, chapter cites within Title 80, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 80 (23 chapters, 744,699 bytes)
```
...
grep -n -E '^## RCW 80\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+80\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
