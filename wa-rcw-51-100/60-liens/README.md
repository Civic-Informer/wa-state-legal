---
name: rcw-title-60
description: Use when the user asks about, cites, quotes, or compares Title 60 RCW — liens — mechanic's liens, materialman's liens, garage keeper's liens, agricultural liens. Triggers on citations like `RCW 60.`, chapter cites within Title 60, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 60 (28 chapters, 326,012 bytes)
```
...
grep -n -E '^## RCW 60\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+60\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
