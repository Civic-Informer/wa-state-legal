---
name: rcw-title-71a
description: Use when the user asks about, cites, quotes, or compares Title 71A RCW — services for individuals with developmental disabilities. Triggers on citations like `RCW 71A.`, chapter cites within Title 71A, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 71A (10 chapters, 179,096 bytes)
```
...
grep -n -E '^## RCW 71A\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+71A\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
