---
name: rcw-title-76
description: Use when the user asks about, cites, quotes, or compares Title 76 RCW — forests and forest products — Forest Practices Act, state forest lands, log scaling. Triggers on citations like `RCW 76.`, chapter cites within Title 76, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 76 (13 chapters, 556,805 bytes)
```
...
grep -n -E '^## RCW 76\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+76\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
