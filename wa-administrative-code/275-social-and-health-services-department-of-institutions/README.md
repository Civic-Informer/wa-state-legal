---
name: wac-275-social-and-health-services-department-of-institutions
description: Use when looking up Title 275 WAC (SOCIAL AND HEALTH SERVICES, DEPARTMENT OF (INSTITUTIONS)). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 275 WAC — SOCIAL AND HEALTH SERVICES, DEPARTMENT OF (INSTITUTIONS)
...
```
275-social-and-health-services-department-of-institutions/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 275 (0 chapters)
```
...
grep -n -A 200 '^## WAC 275-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 275-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 275-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 275-NN WAC` or `WAC 275-NN`
- Section: `WAC 275-NN-NNN`
