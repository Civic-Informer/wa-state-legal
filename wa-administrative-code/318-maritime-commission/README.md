---
name: wac-318-maritime-commission
description: Use when looking up Title 318 WAC (MARITIME COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 318 WAC — MARITIME COMMISSION
...
```
318-maritime-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 318 (0 chapters)
```
...
grep -n -A 200 '^## WAC 318-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 318-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 318-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 318-NN WAC` or `WAC 318-NN`
- Section: `WAC 318-NN-NNN`
