---
name: wac-466-toll-bridge-authority
description: Use when looking up Title 466 WAC (TOLL BRIDGE AUTHORITY). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---
...
```
466-toll-bridge-authority/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 466 (0 chapters)
```
...
grep -n -A 200 '^## WAC 466-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 466-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 466-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 466-NN WAC` or `WAC 466-NN`
- Section: `WAC 466-NN-NNN`
