---
name: wac-186-employees-retirement-statewide-cities
description: Use when looking up Title 186 WAC (EMPLOYEES' RETIREMENT, STATEWIDE CITIES). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 186 WAC — EMPLOYEES' RETIREMENT, STATEWIDE CITIES
...
```
186-employees-retirement-statewide-cities/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 186 (0 chapters)
```
...
grep -n -A 200 '^## WAC 186-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 186-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 186-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 186-NN WAC` or `WAC 186-NN`
- Section: `WAC 186-NN-NNN`
