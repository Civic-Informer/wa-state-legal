---
name: wac-245-health-services-commission
description: Use when looking up Title 245 WAC (HEALTH SERVICES COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 245 WAC — HEALTH SERVICES COMMISSION
...
```
245-health-services-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 245 (0 chapters)
```
...
grep -n -A 200 '^## WAC 245-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 245-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 245-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 245-NN WAC` or `WAC 245-NN`
- Section: `WAC 245-NN-NNN`
