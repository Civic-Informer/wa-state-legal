---
name: wac-356-personnel-department-of-general-government
description: Use when looking up Title 356 WAC (PERSONNEL, DEPARTMENT OF (GENERAL GOVERNMENT)). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 356 WAC — PERSONNEL, DEPARTMENT OF (GENERAL GOVERNMENT)
...
```
356-personnel-department-of-general-government/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 356 (0 chapters)
```
...
grep -n -A 200 '^## WAC 356-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 356-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 356-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 356-NN WAC` or `WAC 356-NN`
- Section: `WAC 356-NN-NNN`
