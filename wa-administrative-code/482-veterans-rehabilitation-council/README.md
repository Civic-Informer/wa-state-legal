---
name: wac-482-veterans-rehabilitation-council
description: Use when looking up Title 482 WAC (VETERANS REHABILITATION COUNCIL). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 482 WAC — VETERANS REHABILITATION COUNCIL
...
```
482-veterans-rehabilitation-council/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 482 (0 chapters)
```
...
grep -n -A 200 '^## WAC 482-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 482-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 482-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 482-NN WAC` or `WAC 482-NN`
- Section: `WAC 482-NN-NNN`
