---
name: wac-199-environmental-hearings-office
description: Use when looking up Title 199 WAC (ENVIRONMENTAL HEARINGS OFFICE). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 199 WAC — ENVIRONMENTAL HEARINGS OFFICE
...
```
199-environmental-hearings-office/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 199 (0 chapters)
```
...
grep -n -A 200 '^## WAC 199-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 199-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 199-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 199-NN WAC` or `WAC 199-NN`
- Section: `WAC 199-NN-NNN`
