---
name: wac-114-chiropractic-examiners-board-of
description: Use when looking up Title 114 WAC (CHIROPRACTIC EXAMINERS, BOARD OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 114 WAC — CHIROPRACTIC EXAMINERS, BOARD OF
...
```
114-chiropractic-examiners-board-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 114 (0 chapters)
```
...
grep -n -A 200 '^## WAC 114-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 114-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 114-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 114-NN WAC` or `WAC 114-NN`
- Section: `WAC 114-NN-NNN`
