---
name: wac-299-law-enforcement-officers-training-commission
description: Use when looking up Title 299 WAC (LAW ENFORCEMENT OFFICERS' TRAINING COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 299 WAC — LAW ENFORCEMENT OFFICERS' TRAINING COMMISSION
...
```
299-law-enforcement-officers-training-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 299 (0 chapters)
```
...
grep -n -A 200 '^## WAC 299-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 299-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 299-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 299-NN WAC` or `WAC 299-NN`
- Section: `WAC 299-NN-NNN`
