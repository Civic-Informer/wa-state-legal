---
name: wac-410-reciprocity-commission
description: Use when looking up Title 410 WAC (RECIPROCITY COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 410 WAC — RECIPROCITY COMMISSION
...
```
410-reciprocity-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 410 (0 chapters)
```
...
grep -n -A 200 '^## WAC 410-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 410-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 410-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 410-NN WAC` or `WAC 410-NN`
- Section: `WAC 410-NN-NNN`
