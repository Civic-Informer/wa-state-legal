---
name: wac-462-teachers-retirement
description: Use when looking up Title 462 WAC (TEACHERS' RETIREMENT). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 462 WAC — TEACHERS' RETIREMENT
...
```
462-teachers-retirement/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 462 (0 chapters)
```
...
grep -n -A 200 '^## WAC 462-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 462-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 462-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 462-NN WAC` or `WAC 462-NN`
- Section: `WAC 462-NN-NNN`
