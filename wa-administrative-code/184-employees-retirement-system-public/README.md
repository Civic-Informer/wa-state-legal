---
name: wac-184-employees-retirement-system-public
description: Use when looking up Title 184 WAC (EMPLOYEES' RETIREMENT SYSTEM, PUBLIC). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 184 WAC — EMPLOYEES' RETIREMENT SYSTEM, PUBLIC
...
```
184-employees-retirement-system-public/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 184 (0 chapters)
```
...
grep -n -A 200 '^## WAC 184-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 184-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 184-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 184-NN WAC` or `WAC 184-NN`
- Section: `WAC 184-NN-NNN`
