---
name: wac-249-higher-education-assistance-authority
description: Use when looking up Title 249 WAC (HIGHER EDUCATION ASSISTANCE AUTHORITY). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 249 WAC — HIGHER EDUCATION ASSISTANCE AUTHORITY
...
```
249-higher-education-assistance-authority/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 249 (0 chapters)
```
...
grep -n -A 200 '^## WAC 249-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 249-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 249-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 249-NN WAC` or `WAC 249-NN`
- Section: `WAC 249-NN-NNN`
