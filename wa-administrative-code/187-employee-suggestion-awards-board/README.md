---
name: wac-187-employee-suggestion-awards-board
description: Use when looking up Title 187 WAC (EMPLOYEE SUGGESTION AWARDS BOARD). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 187 WAC — EMPLOYEE SUGGESTION AWARDS BOARD
...
```
187-employee-suggestion-awards-board/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 187 (0 chapters)
```
...
grep -n -A 200 '^## WAC 187-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 187-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 187-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 187-NN WAC` or `WAC 187-NN`
- Section: `WAC 187-NN-NNN`
