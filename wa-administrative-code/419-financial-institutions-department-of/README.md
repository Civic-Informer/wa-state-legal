---
name: wac-419-financial-institutions-department-of
description: Use when looking up Title 419 WAC (FINANCIAL INSTITUTIONS, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 419 WAC — FINANCIAL INSTITUTIONS, DEPARTMENT OF
...
```
419-financial-institutions-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 419 (0 chapters)
```
...
grep -n -A 200 '^## WAC 419-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 419-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 419-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 419-NN WAC` or `WAC 419-NN`
- Section: `WAC 419-NN-NNN`
