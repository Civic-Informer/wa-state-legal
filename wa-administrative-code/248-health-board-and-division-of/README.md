---
name: wac-248-health-board-and-division-of
description: Use when looking up Title 248 WAC (HEALTH, BOARD AND DIVISION OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 248 WAC — HEALTH, BOARD AND DIVISION OF
...
```
248-health-board-and-division-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 248 (0 chapters)
```
...
grep -n -A 200 '^## WAC 248-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 248-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 248-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 248-NN WAC` or `WAC 248-NN`
- Section: `WAC 248-NN-NNN`
