---
name: wac-320-medical-disciplinary-board
description: Use when looking up Title 320 WAC (MEDICAL DISCIPLINARY BOARD). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 320 WAC — MEDICAL DISCIPLINARY BOARD
...
```
320-medical-disciplinary-board/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 320 (0 chapters)
```
...
grep -n -A 200 '^## WAC 320-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 320-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 320-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 320-NN WAC` or `WAC 320-NN`
- Section: `WAC 320-NN-NNN`
