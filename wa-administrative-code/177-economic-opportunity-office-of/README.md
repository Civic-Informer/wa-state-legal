---
name: wac-177-economic-opportunity-office-of
description: Use when looking up Title 177 WAC (ECONOMIC OPPORTUNITY, OFFICE OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 177 WAC — ECONOMIC OPPORTUNITY, OFFICE OF
...
```
177-economic-opportunity-office-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 177 (0 chapters)
```
...
grep -n -A 200 '^## WAC 177-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 177-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 177-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 177-NN WAC` or `WAC 177-NN`
- Section: `WAC 177-NN-NNN`
