---
name: wac-236-enterprise-services-department-of
description: Use when looking up Title 236 WAC (ENTERPRISE SERVICES, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 236 WAC — ENTERPRISE SERVICES, DEPARTMENT OF
...
```
236-enterprise-services-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 236 (0 chapters)
```
...
grep -n -A 200 '^## WAC 236-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 236-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 236-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 236-NN WAC` or `WAC 236-NN`
- Section: `WAC 236-NN-NNN`
