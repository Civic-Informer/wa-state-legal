---
name: wac-440-social-and-health-services-department-of
description: Use when looking up Title 440 WAC (SOCIAL AND HEALTH SERVICES, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 440 WAC — SOCIAL AND HEALTH SERVICES, DEPARTMENT OF
...
```
440-social-and-health-services-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 440 (0 chapters)
```
...
grep -n -A 200 '^## WAC 440-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 440-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 440-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 440-NN WAC` or `WAC 440-NN`
- Section: `WAC 440-NN-NNN`
