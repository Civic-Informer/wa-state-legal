---
name: wac-120-community-development-office-of
description: Use when looking up Title 120 WAC (COMMUNITY DEVELOPMENT, OFFICE OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 120 WAC — COMMUNITY DEVELOPMENT, OFFICE OF
...
```
120-community-development-office-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 120 (0 chapters)
```
...
grep -n -A 200 '^## WAC 120-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 120-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 120-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 120-NN WAC` or `WAC 120-NN`
- Section: `WAC 120-NN-NNN`
