---
name: wac-098-licensing-department-of
description: Use when looking up Title 98 WAC (LICENSING, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 98 WAC — LICENSING, DEPARTMENT OF
...
```
098-licensing-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 98 (0 chapters)
```
...
grep -n -A 200 '^## WAC 98-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 98-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 98-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 98-NN WAC` or `WAC 98-NN`
- Section: `WAC 98-NN-NNN`
