---
name: wac-154-deferred-compensation-committee-for
description: Use when looking up Title 154 WAC (DEFERRED COMPENSATION, COMMITTEE FOR). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 154 WAC — DEFERRED COMPENSATION, COMMITTEE FOR
...
```
154-deferred-compensation-committee-for/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 154 (0 chapters)
```
...
grep -n -A 200 '^## WAC 154-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 154-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 154-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 154-NN WAC` or `WAC 154-NN`
- Section: `WAC 154-NN-NNN`
