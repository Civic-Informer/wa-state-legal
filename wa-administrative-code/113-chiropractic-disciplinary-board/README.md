---
name: wac-113-chiropractic-disciplinary-board
description: Use when looking up Title 113 WAC (CHIROPRACTIC DISCIPLINARY BOARD). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 113 WAC — CHIROPRACTIC DISCIPLINARY BOARD
...
```
113-chiropractic-disciplinary-board/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 113 (0 chapters)
```
...
grep -n -A 200 '^## WAC 113-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 113-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 113-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 113-NN WAC` or `WAC 113-NN`
- Section: `WAC 113-NN-NNN`
