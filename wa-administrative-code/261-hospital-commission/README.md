---
name: wac-261-hospital-commission
description: Use when looking up Title 261 WAC (HOSPITAL COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 261 WAC — HOSPITAL COMMISSION
...
```
261-hospital-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 261 (0 chapters)
```
...
grep -n -A 200 '^## WAC 261-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 261-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 261-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 261-NN WAC` or `WAC 261-NN`
- Section: `WAC 261-NN-NNN`
