---
name: wac-251-personnel-department-of
description: Use when looking up Title 251 WAC (PERSONNEL, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 251 WAC — PERSONNEL, DEPARTMENT OF
...
```
251-personnel-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 251 (0 chapters)
```
...
grep -n -A 200 '^## WAC 251-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 251-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 251-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 251-NN WAC` or `WAC 251-NN`
- Section: `WAC 251-NN-NNN`
