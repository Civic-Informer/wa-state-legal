---
name: wac-055-basic-health-plan
description: Use when looking up Title 55 WAC (BASIC HEALTH PLAN). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 55 WAC — BASIC HEALTH PLAN
...
```
055-basic-health-plan/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 55 (0 chapters)
```
...
grep -n -A 200 '^## WAC 55-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 55-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 55-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 55-NN WAC` or `WAC 55-NN`
- Section: `WAC 55-NN-NNN`
