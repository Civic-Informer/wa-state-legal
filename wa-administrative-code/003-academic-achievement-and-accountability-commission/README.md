---
name: wac-003-academic-achievement-and-accountability-commission
description: Use when looking up Title 3 WAC (ACADEMIC ACHIEVEMENT AND ACCOUNTABILITY COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 3 WAC — ACADEMIC ACHIEVEMENT AND ACCOUNTABILITY COMMISSION
...
└── rules.md    <- consolidated chapter section indexes for Title 3 (0 chapters)
```
...
grep -n -A 200 '^## WAC 3-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 3-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 3-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 3-NN WAC` or `WAC 3-NN`
- Section: `WAC 3-NN-NNN`
