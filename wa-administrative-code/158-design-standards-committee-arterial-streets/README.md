---
name: wac-158-design-standards-committee-arterial-streets
description: Use when looking up Title 158 WAC (DESIGN STANDARDS COMMITTEE-ARTERIAL STREETS). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 158 WAC — DESIGN STANDARDS COMMITTEE-ARTERIAL STREETS
...
```
158-design-standards-committee-arterial-streets/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 158 (0 chapters)
```
...
grep -n -A 200 '^## WAC 158-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 158-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 158-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 158-NN WAC` or `WAC 158-NN`
- Section: `WAC 158-NN-NNN`
