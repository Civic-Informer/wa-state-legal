---
name: wac-170-early-learning-department-of
description: Use when looking up Title 170 WAC (EARLY LEARNING, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---
...
```
170-early-learning-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 170 (0 chapters)
```
...
grep -n -A 200 '^## WAC 170-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 170-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 170-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 170-NN WAC` or `WAC 170-NN`
- Section: `WAC 170-NN-NNN`
