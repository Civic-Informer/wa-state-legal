---
name: wac-252-highway-commission
description: Use when looking up Title 252 WAC (HIGHWAY COMMISSION). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 252 WAC — HIGHWAY COMMISSION
...
```
252-highway-commission/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 252 (0 chapters)
```
...
grep -n -A 200 '^## WAC 252-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 252-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 252-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 252-NN WAC` or `WAC 252-NN`
- Section: `WAC 252-NN-NNN`
