---
name: wac-402-radiation-control-agency
description: Use when looking up Title 402 WAC (RADIATION CONTROL AGENCY). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 402 WAC — RADIATION CONTROL AGENCY
...
```
402-radiation-control-agency/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 402 (0 chapters)
```
...
grep -n -A 200 '^## WAC 402-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 402-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 402-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 402-NN WAC` or `WAC 402-NN`
- Section: `WAC 402-NN-NNN`
