---
name: wac-290-judicial-retirement-board
description: Use when looking up Title 290 WAC (JUDICIAL RETIREMENT BOARD). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 290 WAC — JUDICIAL RETIREMENT BOARD
...
```
290-judicial-retirement-board/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 290 (0 chapters)
```
...
grep -n -A 200 '^## WAC 290-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 290-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 290-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 290-NN WAC` or `WAC 290-NN`
- Section: `WAC 290-NN-NNN`
