---
name: wac-380-printing-and-duplicating-committee
description: Use when looking up Title 380 WAC (PRINTING AND DUPLICATING COMMITTEE). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 380 WAC — PRINTING AND DUPLICATING COMMITTEE
...
```
380-printing-and-duplicating-committee/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 380 (0 chapters)
```
...
grep -n -A 200 '^## WAC 380-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 380-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 380-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 380-NN WAC` or `WAC 380-NN`
- Section: `WAC 380-NN-NNN`
