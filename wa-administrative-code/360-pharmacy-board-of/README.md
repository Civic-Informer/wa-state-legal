---
name: wac-360-pharmacy-board-of
description: Use when looking up Title 360 WAC (PHARMACY, BOARD OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 360 WAC — PHARMACY, BOARD OF
...
```
360-pharmacy-board-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 360 (0 chapters)
```
...
grep -n -A 200 '^## WAC 360-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 360-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 360-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 360-NN WAC` or `WAC 360-NN`
- Section: `WAC 360-NN-NNN`
