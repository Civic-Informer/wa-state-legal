---
name: wac-050-financial-institutions
description: Use when looking up Title 50 WAC (FINANCIAL INSTITUTIONS,). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 50 WAC — FINANCIAL INSTITUTIONS,
...
```
050-financial-institutions/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 50 (0 chapters)
```
...
grep -n -A 200 '^## WAC 50-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 50-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 50-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 50-NN WAC` or `WAC 50-NN`
- Section: `WAC 50-NN-NNN`
