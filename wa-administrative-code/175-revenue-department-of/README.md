---
name: wac-175-revenue-department-of
description: Use when looking up Title 175 WAC (REVENUE, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 175 WAC — REVENUE, DEPARTMENT OF
...
```
175-revenue-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 175 (0 chapters)
```
...
grep -n -A 200 '^## WAC 175-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 175-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 175-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 175-NN WAC` or `WAC 175-NN`
- Section: `WAC 175-NN-NNN`
