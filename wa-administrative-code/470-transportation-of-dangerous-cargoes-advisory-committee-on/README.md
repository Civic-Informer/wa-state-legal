---
name: wac-470-transportation-of-dangerous-cargoes-advisory-committee-on
description: Use when looking up Title 470 WAC (TRANSPORTATION OF DANGEROUS CARGOES, ADVISORY COMMITTEE ON). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 470 WAC — TRANSPORTATION OF DANGEROUS CARGOES, ADVISORY COMMITTEE ON
...
```
470-transportation-of-dangerous-cargoes-advisory-committee-on/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 470 (0 chapters)
```
...
grep -n -A 200 '^## WAC 470-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 470-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 470-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 470-NN WAC` or `WAC 470-NN`
- Section: `WAC 470-NN-NNN`
