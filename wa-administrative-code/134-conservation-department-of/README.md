---
name: wac-134-conservation-department-of
description: Use when looking up Title 134 WAC (CONSERVATION, DEPARTMENT OF). NOTE: this title has no active chapters in the 2025 archive — sections were either repealed or recodified elsewhere. Use to confirm a section is no longer in this title.
---

# Title 134 WAC — CONSERVATION, DEPARTMENT OF
...
```
134-conservation-department-of/
├── README.md   <- you are here
└── rules.md    <- consolidated chapter section indexes for Title 134 (0 chapters)
```
...
grep -n -A 200 '^## WAC 134-' rules.md | less

# A specific chapter
grep -n -A 200 '^## WAC 134-NN ' rules.md  # replace NN with chapter number

# A specific section by number anywhere in the title
grep -n 'WAC 134-NNN-NNN' rules.md  # replace NNN-NNN with section
```

## Citation format

- Chapter: `chapter 134-NN WAC` or `WAC 134-NN`
- Section: `WAC 134-NN-NNN`
