---
name: rcw-title-03
description: Use when the user asks about, cites, quotes, or compares Title 03 RCW — district courts and courts of limited jurisdiction; judicial selection and qualification for those courts. Triggers on citations like `RCW 03.`, chapter cites within Title 03, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 03 RCW — DISTRICT COURTS—COURTS OF LIMITED JURISDICTION
...
```
03-district-courts-courts-of-limited-jurisdiction/
├── README.md   ← you are here
└── rules.md    ← consolidated text of every chapter in Title 03 (15 chapters, 185,531 bytes)
```
...
grep -n -E '^## RCW 03\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+03\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
