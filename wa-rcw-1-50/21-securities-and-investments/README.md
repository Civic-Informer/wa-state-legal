---
name: rcw-title-21
description: Use when the user asks about, cites, quotes, or compares Title 21 RCW — securities regulation, broker-dealer registration, investment adviser regulation, securities fraud. Triggers on citations like `RCW 21.`, chapter cites within Title 21, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 21 (4 chapters, 244,711 bytes)
```
...
grep -n -E '^## RCW 21\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+21\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
