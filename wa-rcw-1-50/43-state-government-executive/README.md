---
name: rcw-title-43
description: Use when the user asks about, cites, quotes, or compares Title 43 RCW — state government executive branch — Governor, Lieutenant Governor, principal agencies (DOL, DSHS, Ecology, Commerce, etc.). Triggers on citations like `RCW 43.`, chapter cites within Title 43, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 43 (178 chapters, 6,894,036 bytes)
```
...
grep -n -E '^## RCW 43\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+43\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
