---
name: rcw-title-31
description: Use when the user asks about, cites, quotes, or compares Title 31 RCW — small loans, consumer loans, check cashers, payday lending. Triggers on citations like `RCW 31.`, chapter cites within Title 31, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 31 (8 chapters, 462,609 bytes)
```
...
grep -n -E '^## RCW 31\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+31\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
