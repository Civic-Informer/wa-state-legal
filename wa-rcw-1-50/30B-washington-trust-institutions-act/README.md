---
name: rcw-title-30b
description: Use when the user asks about, cites, quotes, or compares Title 30B RCW — the Washington Trust Institutions Act — trust companies, fiduciary powers. Triggers on citations like `RCW 30B.`, chapter cites within Title 30B, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 30B RCW — WASHINGTON TRUST INSTITUTIONS ACT
...
└── rules.md    ← consolidated text of every chapter in Title 30B (14 chapters, 232,757 bytes)
```
...
grep -n -E '^## RCW 30B\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+30B\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
