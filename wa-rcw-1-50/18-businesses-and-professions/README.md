---
name: rcw-title-18
description: Use when the user asks about, cites, quotes, or compares Title 18 RCW — occupational licensing — physicians, lawyers, real estate brokers, contractors, cosmetologists, and dozens of other regulated professions. Triggers on citations like `RCW 18.`, chapter cites within Title 18, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 18 (113 chapters, 4,191,172 bytes)
```
...
grep -n -E '^## RCW 18\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+18\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
