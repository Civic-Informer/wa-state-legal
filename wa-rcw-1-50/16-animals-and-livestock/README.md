---
name: rcw-title-16
description: Use when the user asks about, cites, quotes, or compares Title 16 RCW — animal cruelty, livestock identification, dairy/poultry, dangerous dogs. Triggers on citations like `RCW 16.`, chapter cites within Title 16, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 16 (20 chapters, 417,547 bytes)
```
...
grep -n -E '^## RCW 16\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+16\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
