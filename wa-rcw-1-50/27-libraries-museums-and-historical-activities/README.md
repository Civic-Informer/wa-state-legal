---
name: rcw-title-27
description: Use when the user asks about, cites, quotes, or compares Title 27 RCW — libraries, museums, historical societies, public records of historical value. Triggers on citations like `RCW 27.`, chapter cites within Title 27, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 27 (12 chapters, 225,064 bytes)
```
...
grep -n -E '^## RCW 27\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+27\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
