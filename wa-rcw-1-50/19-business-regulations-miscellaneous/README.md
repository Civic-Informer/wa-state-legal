---
name: rcw-title-19
description: Use when the user asks about, cites, quotes, or compares Title 19 RCW — miscellaneous business regulations — Consumer Protection Act, advertising, telemarketing, franchises, unfair trade practices. Triggers on citations like `RCW 19.`, chapter cites within Title 19, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 19 (111 chapters, 2,763,454 bytes)
```
...
grep -n -E '^## RCW 19\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+19\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
