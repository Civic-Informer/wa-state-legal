---
name: rcw-title-38
description: Use when the user asks about, cites, quotes, or compares Title 38 RCW — the state militia (Washington National Guard) and military affairs, military service member protections. Triggers on citations like `RCW 38.`, chapter cites within Title 38, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 38 (18 chapters, 495,944 bytes)
```
...
grep -n -E '^## RCW 38\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+38\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
