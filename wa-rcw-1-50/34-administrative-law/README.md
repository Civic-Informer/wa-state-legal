---
name: rcw-title-34
description: Use when the user asks about, cites, quotes, or compares Title 34 RCW — the Administrative Procedure Act — agency rulemaking, adjudication, judicial review, declaratory orders. Triggers on citations like `RCW 34.`, chapter cites within Title 34, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 34 (3 chapters, 266,847 bytes)
```
...
grep -n -E '^## RCW 34\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+34\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
