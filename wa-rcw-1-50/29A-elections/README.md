---
name: rcw-title-29a
description: Use when the user asks about, cites, quotes, or compares Title 29A RCW — elections — voter registration, ballot procedures, recounts, recall, campaign and political committees. Triggers on citations like `RCW 29A.`, chapter cites within Title 29A, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 29A (22 chapters, 818,146 bytes)
```
...
grep -n -E '^## RCW 29A\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+29A\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
