---
name: rcw-title-14
description: Use when the user asks about, cites, quotes, or compares Title 14 RCW — aeronautics, airports, airspace, drone regulation, aircraft fuel tax. Triggers on citations like `RCW 14.`, chapter cites within Title 14, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 14 (7 chapters, 130,278 bytes)
```
...
grep -n -E '^## RCW 14\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+14\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
