---
name: rcw-title-23b
description: Use when the user asks about, cites, quotes, or compares Title 23B RCW — the Washington Business Corporation Act — formation, governance, mergers, dissolution, derivative actions. Triggers on citations like `RCW 23B.`, chapter cites within Title 23B, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 23B (22 chapters, 467,065 bytes)
```
...
grep -n -E '^## RCW 23B\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+23B\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
