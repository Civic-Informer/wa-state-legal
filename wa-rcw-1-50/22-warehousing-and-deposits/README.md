---
name: rcw-title-22
description: Use when the user asks about, cites, quotes, or compares Title 22 RCW — warehousing, grain elevators, public warehouse receipts. Triggers on citations like `RCW 22.`, chapter cites within Title 22, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 22 (4 chapters, 147,788 bytes)
```
...
grep -n -E '^## RCW 22\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+22\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
