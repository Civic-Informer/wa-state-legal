---
name: rcw-title-10
description: Use when the user asks about, cites, quotes, or compares Title 10 RCW — criminal procedure, arrest, search and seizure, bail, plea, trial, post-conviction relief, victim's rights. Triggers on citations like `RCW 10.`, chapter cites within Title 10, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---
...
└── rules.md    ← consolidated text of every chapter in Title 10 (52 chapters, 938,528 bytes)
```
...
grep -n -E '^## RCW 10\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+10\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
