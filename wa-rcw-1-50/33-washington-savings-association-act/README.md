---
name: rcw-title-33
description: Use when the user asks about, cites, quotes, or compares Title 33 RCW — the Washington Savings Association Act — state-chartered savings associations. Triggers on citations like `RCW 33.`, chapter cites within Title 33, and subject keywords drawn from the chapter list inside `rules.md`. Do NOT use for: WAC regulations, court rules, federal law, or matters governed by other RCW Titles.
---

# Title 33 RCW — WASHINGTON SAVINGS ASSOCIATION ACT
...
└── rules.md    ← consolidated text of every chapter in Title 33 (15 chapters, 185,079 bytes)
```
...
grep -n -E '^## RCW 33\.' rules.md

# Pull a specific section's body (typically 30-90 lines)
grep -n -A 60 -E 'RCW\s+33\.[0-9]+[A-Z]?[.-][0-9]+' rules.md | head -80
