...
```bash
grep -n -E '^\s*(LCrRLJ|LIRLJ) ?[0-9]' rules.md
```

## Citation examples

- `Mason County District Court LCrRLJ {rule number}`
- `Mason County District Court LIRLJ {rule number}`
