...
```bash
grep -n -E '^\s*(LCRLJ|LIRLJ) ?[0-9]' rules.md
```

## Citation examples

- `Adams County District Court LCRLJ {rule number}`
- `Adams County District Court LIRLJ {rule number}`
